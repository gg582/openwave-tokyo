...
- **파도 쇄파 및 물보라(Spindrift)**: 해양 솔버 내에서 물리 기반 Jacobian 거품 생성 승수(1.8) 및 지수 거품 주입률(0.45)을 전격 복구하고, 이상파랑(Rogue wave) 집중 영역에서 쇄파 난류 강도를 대폭 부스팅합니다. 망원 카메라 관측 거리를 고려해 입자의 시각 스케일을 18.0배 보정하여, 350m 너머에서도 기포가 흩뿌리는 세찬 물보라(spindrift) 구름이 역동적으로 인지됩니다.
